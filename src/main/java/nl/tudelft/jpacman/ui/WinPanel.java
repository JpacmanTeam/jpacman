...
public class WinPanel extends JPanel {
    ...
    public WinPanel(){
        ...
        nextButton = new ButtonOnPage(new ImageIcon(NEXT_BUTTON_SOURCE),new Rectangle(130,275,120,40));
        //define home button by image source and size
        homeButton = new ButtonOnPage(new ImageIcon(HOME_BUTTON_SOURCE),new Rectangle(130,350,120,40));
